...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'new-presta', 'user' => 'presta_admin', 'password' => 'presta_admin', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/opt/lampp/htdocs/be-prestashop/modules/ps_checkout/src/Entity']);
        $d->addExcludePaths([0 => '/opt/lampp/htdocs/be-prestashop/modules/ps_checkout/src/Entity/index.php']);
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/opt/lampp/htdocs/be-prestashop/modules/productcomments/src/Entity']);
        $e->addExcludePaths([0 => '/opt/lampp/htdocs/be-prestashop/modules/productcomments/src/Entity/index.php']);

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => '/opt/lampp/htdocs/be-prestashop/src/PrestaShopBundle/Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('/opt/lampp/htdocs/be-prestashop/var/cache/prod//doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_bbb24b31645e1598eee06ca8c051bc98402297f56b5cc232722f5275c78f7a4a');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/opt/lampp/htdocs/be-prestashop/var/cache/prod//localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(${($_ = isset($this->services['prestashop.core.localization.cldr.cache.adapter']) ? $this->services['prestashop.core.localization.cldr.cache.adapter'] : ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/opt/lampp/htdocs/be-prestashop/var/cache/prod//localization'))) && false ?: '_'});
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('1.7.8.7', '/opt/lampp/htdocs/be-prestashop', false);
    }
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.7.8.7', '/opt/lampp/htdocs/be-prestashop');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => '/opt/lampp/htdocs/be-prestashop/app',
            'kernel.project_dir' => '/opt/lampp/htdocs/be-prestashop',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => '/opt/lampp/htdocs/be-prestashop/var/cache/prod/',
            ...
            'ps_cache_dir' => '/opt/lampp/htdocs/be-prestashop/var/cache/prod/',
            ...
            'doctrine.orm.proxy_dir' => '/opt/lampp/htdocs/be-prestashop/var/cache/prod//doctrine/orm/Proxies',
